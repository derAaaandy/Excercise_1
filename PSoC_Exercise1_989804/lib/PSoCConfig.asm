...
export LoadConfig_psoc_exercise1_989804
export _LoadConfig_psoc_exercise1_989804
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_psoc_exercise1_989804
	lcall	LoadConfigTBL_psoc_exercise1_989804_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration psoc_exercise1_989804
;
;    Load configuration registers for psoc_exercise1_989804.
...
;               CUR_PP
;
_LoadConfig_psoc_exercise1_989804:
 LoadConfig_psoc_exercise1_989804:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_psoc_exercise1_989804_Bank0
    mov     X, <LoadConfigTBL_psoc_exercise1_989804_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_psoc_exercise1_989804_Bank1
    mov     X, <LoadConfigTBL_psoc_exercise1_989804_Bank1
